...
public class frmVer extends javax.swing.JFrame {
    ...
    public frmVer() {
        ...
        /**
         * Correción añadida:
         *  El programa detecta que no sobrepase el numero de nodos
         *  O repita nodos
         */
        if (aux != null) //Primer nodo
        {
            if (aux == Principal.fin) {
            ...
            }else
            {
                ...
                if (aux == Principal.fin) // Segundo nodo
                {   
                ...
                }else
                {
                    visualizarNodo(lblCodigo2,lblNombre2,lblEdad2,lblFrase2,lblFoto2);
                    aux = aux.getSiguiente();  
                    if (aux == Principal.fin) // Tercer nodo
                    {
                    ...
                    }else
                    {
                        visualizarNodo(lblCodigo3,lblNombre3,lblEdad3,lblFrase3,lblFoto3);
                        aux = aux.getSiguiente();  
                        if (aux == Principal.fin) //Cuarto nodo (aqui se queda)
                        {
    ...
    void RecDerecha()
    {
        ...
        }else
        {
           ...
           visualizarNodo(lblCodigo3,lblNombre3,lblEdad3,lblFrase3,lblFoto3);
            if (aux.getSiguiente() == Principal.inicio) //Revisa que haya informacion en el nodo 6
            { //Si no hay informacion, deja todo vacio
                ...
                btnSiguiente.setVisible(false);
                aux = aux.getSiguiente();
            }else if(aux.getSiguiente().getSiguiente()==Principal.inicio)
            {
                btnSiguiente.setVisible(false);
