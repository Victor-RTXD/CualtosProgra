...
public class CargaElectrica {
    ...
    public void procedimiento(float q1, float q2, float r, double exponente) {
        ...
        this.r = sc.nextFloat();
        System.out.println("sus cargas tienen exponente?");
    ...
    public void leyCoulomb() {
        do {
            ...
            System.out.println("Es fuerza de repulsion");
            }
            else if(f1<0){
            System.out.println("f1: " + f1);
            System.out.println("Es fuerza de atraccion");
            }
            else{
            System.out.println("f1 es 0");
            }
